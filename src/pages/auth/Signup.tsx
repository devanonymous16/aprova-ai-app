    ...
    >
      <div className="space-y-6">
        <div className="grid grid-cols-2 gap-4">
          ...
          >
            <svg className="mr-2 h-4 w-4" viewBox="0 0 24 24">
              <path d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm0 18c-4.411 0-8-3.589-8-8s3.589-8 8-8 8 3.589 8 8-3.589 8-8 8zm-.5-13v2h1v-2h-1zm0 3v6h1v-6h-1z" fill="currentColor"/>
            </svg>
            Apple
          </Button>
        </div>
