  ...
  return (
    <div key={group.id} className="border rounded-md p-3 text-sm">
      <div className="flex justify-between items-center mb-1">
        <span className="font-semibold">{group.difficultyArea}</span>
        <span className="text-xs text-muted-foreground flex items-center gap-1"><Users2 className="h-3 w-3"/> {group.studentCount} Alunos</span>
      </div>
      {/* Usa a string pré-calculada */}
